...
The only samples that were replicated were controls, so this part of the SOP isn't really doing anything.
...
```{r}
#lets get rid of the last control

genos_0.2 %<>%
  filter(!str_detect(Sample, "HetAn"))
```
### Sex Ratios
...
"Omy_RAD57916-29", "Omy_RAD29352-6"
Removed 2 bad markers
```{r}
# Local R
